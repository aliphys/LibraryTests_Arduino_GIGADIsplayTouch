/**
 * Test Scenario ID : TPL-ARD-GIGADT-001-ValuePolling
 *
 * This sketch obtains the border touch co-ordinates via polling
 *
 * Test Case IDs :
 * TPL-ARD-GIGADT-001-ValuePolling-TL -> Get border x,y value for top left corner
 * TPL-ARD-GIGADT-001-ValuePolling-TR -> Get border x,y value for top right corner
 * TPL-ARD-GIGADT-001-ValuePolling-BR -> Get border x,y value for bottom right corner
 * TPL-ARD-GIGADT-001-ValuePolling-BL -> Get border x,y value for bottom left corner
 *
...
void setup() {
    ...
    Serial.println("TPL-ARD-GIGADT-001-ValuePolling-TL");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("TPL-ARD-GIGADT-001-ValuePolling-TR");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("TPL-ARD-GIGADT-001-ValuePolling-BR");
    ...
    Serial.println("---");
    Serial.print("Test Case ID: ");
    Serial.println("TPL-ARD-GIGADT-001-ValuePolling-BL");
